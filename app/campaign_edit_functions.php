...
public static function options_box( $post ) { 
	...
	?>
		...
		<p><!-- 修改线-->
			...
			<input name="campaign_author" type="number" size="3"class="small-text" value="<?php echo $campaign_data['campaign_author']; ?>"id="campaign_author">
			...
			请在保存设置时确认此处数字最终显示为你需要的作者id 如果为0请尝试重新输入值。
		</p><!-- 修改线-->
	</div>	
